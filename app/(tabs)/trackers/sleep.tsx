...
export default function SleepTrackerScreen() {
  ...
  return (
    <View style={styles.screen}>
      <ModernHeader
        title="Sleep Tracker"
        subtitle="Monitor naps and nighttime sleep"
        showBackButton
      ...
      >
        {selectedBabyId ? (
          ...
          >
            <GlassCard variant="calm" size="lg" delay={100}>
              <View style={styles.cardHeader}>
                <GradientIcon
                  ...
                  delay={200}
                />
                <Text style={styles.cardTitle}>Log Sleep Session</Text>
              </View>
            ...
            <GlassCard variant="default" size="lg" delay={100}>
              <View style={styles.emptyState}>
                ...
                <Text style={styles.emptyStateText}>
                  Please select a baby to start tracking sleep patterns
                </Text>
              </View>
            </GlassCard>
          </MotiView>
