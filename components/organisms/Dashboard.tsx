...
export function Dashboard({
  ...
  return (
    ...
    >
      <Text variant="title" className="text-3xl font-bold text-white mb-6">Welcome back!</Text>

      <View className="mb-8">
        <Text variant="subtitle" className="text-nano-400 mb-4 font-semibold uppercase tracking-wider text-xs">Quick Actions</Text>
      ...
      <View className="mb-8">
        <Text variant="subtitle" className="text-nano-400 mb-4 font-semibold uppercase tracking-wider text-xs">Today's Stats</Text>
        <View className="flex-row gap-3">
          <Card variant="glass" className="flex-1 items-center p-4">
            ...
            <Text className="text-nano-500 text-[10px] uppercase font-bold mt-1">Feeds</Text>
          </Card>
          ...
          <Card variant="glass" className="flex-1 items-center p-4">
            ...
            <Text className="text-nano-500 text-[10px] uppercase font-bold mt-1">Diapers</Text>
          </Card>
          ...
          <Card variant="glass" className="flex-1 items-center p-4">
            ...
            <Text className="text-white text-xl font-bold text-center" numberOfLines={1}>{todaySleep}</Text>
            <Text className="text-nano-500 text-[10px] uppercase font-bold mt-1">Sleep</Text>
          </Card>
        </View>
      </View>
      ...
      <View className="mb-8">
        <View className="flex-row justify-between items-center mb-4">
          <Text variant="subtitle" className="text-nano-400 font-semibold uppercase tracking-wider text-xs">Recent Activity</Text>
          <TouchableOpacity>
        ...
        {activityFeed || (
          <Card variant="default" className="bg-nano-900 border-nano-800 p-8 items-center">
            <Ionicons name="time-outline" size={48} color="#333" />
            <Text className="text-white font-semibold mt-4">No activity yet</Text>
      ...
      <View className="mb-0">
        <Text variant="subtitle" className="text-nano-400 mb-4 font-semibold uppercase tracking-wider text-xs">Mood Trends</Text>
        {moodData.length > 0 ? (
          ...
          <Card variant="default" className="bg-nano-900 border-nano-800 p-6 items-center flex-row gap-4">
            ...
            <View className="flex-1">
               ...
               <Text className="text-nano-500 text-xs mt-1">Start tracking to see weekly trends.</Text>
            </View>
